 ...
 * Created on January 28, 2023 4:40 PM
...
void problem6();
string outRed(int);
float seque(float x, int nterms);       
...
void problem6()
{
    ...
    cout<<"Calculate a series f(x)=x-x^3/3!+x^5/5!-x^7/7!+......."<<endl;               //Output prompt 
    cout<<"Input x and the number of terms, output f(x)"<<endl;
    
    cin>>x>>nterms;                                                                     //user input
    


    float powr = x, expo = 0.0;                                                         //power, exponent
    int num = 0, fac;                                                                   //factor, number
    
    
    for (int i = 1; num < nterms; i = i + 2)                                            //Calculates Sequence
    {  
       fac = 1;     
       num++;        
